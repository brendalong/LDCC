...
### Bonus
1. Add the ability to add a snack - but only for admin users.
1. Add edit to the snack display - but only for admin users. This one is tricky since there is an option to have multiple toppings.
